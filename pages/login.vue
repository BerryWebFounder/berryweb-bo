      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
        ...
        <div class="mt-6">
          ...
          <div class="mt-6 grid grid-cols-2 gap-3">
            ...
            >
              <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24">
                <path fill="currentColor" d="M12 3C6.48 3 2 6.48 2 10.5c0 2.38 1.45 4.52 3.7 5.98L4 21l5.22-2.61C10.08 18.78 11.03 19 12 19c5.52 0 10-3.48 10-7.5S17.52 3 12 3z"/>
              </svg>
              Kakao
            </button>
          </div>
...
const handleGoogleLogin = () => {
  if (!config.public.oauthGoogleClientId) {
    alert('Google OAuth 설정이 필요합니다.')
    return
  }
...
const handleKakaoLogin = () => {
  if (!config.public.oauthKakaoClientId) {
    alert('Kakao OAuth 설정이 필요합니다.')
    return
  }
